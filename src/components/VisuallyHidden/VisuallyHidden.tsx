...
export interface Props extends Omit<HTMLAttributes<HTMLDivElement>, 'className' | 'style'> {
...
export const VisuallyHidden = forwardRef<HTMLDivElement, Props>(function VisuallyHidden(
    { children, classNameOnFocus, ...htmlAttributes },
    externalRef,
) {
